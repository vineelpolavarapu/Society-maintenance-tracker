...
export default function AdminLogin() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      if (user.role !== 'treasurer') {
        setErr('Admin access required. Please log in with treasurer credentials.')
        return
      }
  ...
  return (
    <div className="auth-wrap admin-login">
      <div className="auth-card admin-card">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
          ...
          <div>
            ...
            <p style={{ marginBottom: 0, marginTop: 2 }}>Treasurer (Admin) Portal</p>
          </div>
        </div>
